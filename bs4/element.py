...
class PageElement(object):
    ...
    def insert_before(self, *args:PageElement) -> Iterable[PageElement]:
        ...
        :return A list of the PageElements that were inserted.
        """
        parent = self.parent
        if parent is None:
            raise ValueError(
    ...
    def insert_after(self, *args:PageElement) -> Iterable[TagElement]:
...
class Tag(PageElement):
    ...
    def insert(self, position:int, new_child:PageElement) -> PageElement:
    ...
    def append(self, tag:PageElement) -> PageElement:
    ...
    def extend(self, tags:Iterable[PageElement]|Tag) -> Iterable[PageElement]:
        ...
        :return The list of PageElements that was appended.
        """
        ...
        if isinstance(tags, Tag):
            ...
            warnings.warn(
                "A single item (not a Tag) was passed into Tag.extend. Use Tag.append instead.",
                stacklevel=2
            )
            tag_list = [tags]
...
class Tag(PageElement):
    ...
    parserClass = _deprecated_alias("parserClass", "parser_class", "3.0.0")  # BS3
